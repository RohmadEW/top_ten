...
export const products: Product[] = [
  {
    ...
    pros: [
      "Excellent audio quality with woofer and tweeter. Longer battery life compared to Buds Pro.",
      "Adaptive noise cancellation and ambient mode adjust themselves when sensing conversations.",
      "3D audio lets music feel immersive. Strong water resistance.",
    ],
